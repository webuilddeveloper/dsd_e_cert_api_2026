...
namespace cms_api.Controllers
{
    ...
    public class FundController : Controller
    {
        ...
        public ActionResult<Response> Create([FromBody] News value)
        {
            ...
            try
            {
                var col = new Database().MongoClient("fund");
                ...
                {
                    Task.Run(() => { value.organization.createQrganizationAuto(value.code, "fund"); });
        ...
        public ActionResult<Response> Read([FromBody] Criteria value)
        {
            try
            {
                ...
                var col = new Database().MongoClient<News>("fund");
                ...
                List<News> docs = col.Aggregate().Match(filter).SortBy(o => o.sequence).ThenByDescending(o => o.docDate).ThenByDescending(o => o.updateTime).Skip(value.skip).Limit(value.limit)
                                      .Lookup("fundCategory", "category", "code", "categoryList")
                                      .As<News>()
                                      .ToList();
        ...
        public ActionResult<Response> GalleryCreate([FromBody] Gallery value)
        {
            ...
            try
            {
                var col = new Database().MongoClient("fundGallery");
        ...
        public ActionResult<Response> CommentCreate([FromBody] Comment value)
        {
            ...
            try
            {
                var col = new Database().MongoClient("fundComment");
        ...
        public ActionResult<Response> CommentRead([FromBody] Criteria value)
        {
            try
            {
                var col = new Database().MongoClient<Comment>("fundComment");
        ...
        public ActionResult<Response> CategoryCreate([FromBody] Category value)
        {
            ...
            try
            {
                var col = new Database().MongoClient("fundCategory");
        ...
        public ActionResult<Response> CategoryRead([FromBody] Criteria value)
        {
            try
            {
                var col = new Database().MongoClient<Category>("fundCategory");
        ...
        public ActionResult<Response> CategoryUpdate([FromBody] Category value)
        {
            ...
            try
            {
                ...
                if (!value.isActive)
                {
                    var collectionContent = new Database().MongoClient("fund");
                ...
                if (!value.isActive)
                {
                    ...
                    var updatePermission = Builders<BsonDocument>.Update.Set("fundPage", false).Set("isActive", false);
        ...
        public ActionResult<Response> ReOrder([FromBody] EventCalendar value)
        {
            ...
            try
            {
                var col = new Database().MongoClient<BsonDocument>("fund");
