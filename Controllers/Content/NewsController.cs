    ...
    public class NewsController : Controller
    {
        ...
        public ActionResult<Response> Create([FromBody] News value)
        {
            ...
            try
            {
                ...
                {
                    Task.Run(() => { value.organization.createQrganizationAuto(value.code, "news"); });
        ...
        public ActionResult<Response> GalleryCreate([FromBody] Gallery value)
        {
            ...
            try
            {
                var col = new Database().MongoClient( "newsGallery");
        ...
        public ActionResult<Response> CategoryRead([FromBody] Criteria value)
        {
            try
            {
                ...
                var docs = col.Find(filter).SortByDescending(o => o.docDate).ThenByDescending(o => o.updateTime).Skip(value.skip).Limit(value.limit).Project(c => new { c.code, c.title , c.titleEN, c.language, c.imageUrl, c.createBy, c.createDate, c.isActive, c.updateBy, c.updateDate, c.sequence ,}).ToList();
        ...
        public ActionResult<Response> ReOrder([FromBody] EventCalendar value)
        {
            ...
            try
            {
                var col = new Database().MongoClient<BsonDocument>("news");
